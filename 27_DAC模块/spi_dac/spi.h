...
#define ESCPI1_BASE ((p_SPI_CTRL)0x2008000)
#define ESCPI2_BASE ((p_SPI_CTRL)0x200c000)
#define ESCPI3_BASE ((p_SPI_CTRL)0x2010000)
#define ESCPI4_BASE ((p_SPI_CTRL)0x2014000)
